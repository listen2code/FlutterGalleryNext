          ...
          Padding(
            ...
            child: Wrap(
              ...
              children: [
                ...
                _buildThemeRoleBox('Outline', colorScheme.outline, colorScheme.onSurface.withAlpha(153)),
              ],
            ),
          ),
  ...
  Widget _buildThemeRoleBox(String label, Color bg, Color onColor) {
    return Column(
      children: [
        ...
        Text('on$label', style: TextStyle(fontSize: 10, color: onColor.withAlpha(179))),
      ],
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(bg.toString().substring(10, 16).toUpperCase(), style: TextStyle(color: text.withAlpha(153), fontSize: 11)),
          ],
        ),
      ),
    );
  ...
  Widget _buildStatusBanner(String label, Color main, Color bg, Color text, IconData icon) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: main.withAlpha(128)),
      ),
      child: Row(
        children: [
          ...
          const Spacer(),
          Text('on$label', style: TextStyle(color: text.withAlpha(153), fontSize: 10)),
        ],
      ),
    );
  }
