...
class Level1Node extends TreeNode {
  Level1Node({
    ...
    super.onTap,
    super.padding,
    super.leftPadding = 16.0,
    super.dividerLeftPadding = 0.0,
    super.leftTitleStyle = const TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
    super.leftSubTitleStyle,
    super.rightTitleStyle,
    super.rightLabelStyle,
    super.rightSubtitleStyle,
    super.leftMaxLine,
    super.leftSubMaxLine,
    super.hideRightOnExpand,
    super.showStatusColors,
    super.minHeight = 60,
    super.maxHeight,
  });
}
...
class Level2Node extends TreeNode {
  Level2Node({
    ...
    super.onTap,
    super.padding,
    super.leftPadding = 32.0,
    super.dividerLeftPadding = 32.0,
    super.leftTitleStyle = const TextStyle(fontSize: 14, fontWeight: FontWeight.w500),
    super.leftSubTitleStyle,
    super.rightTitleStyle,
    super.rightLabelStyle,
    super.rightSubtitleStyle,
...
class Level3Node extends TreeNode {
  Level3Node({
    ...
    super.onTap,
    super.padding,
    super.leftPadding = 56.0,
    super.dividerLeftPadding = 32.0,
    super.leftTitleStyle = const TextStyle(fontSize: 13),
    super.leftSubTitleStyle,
    super.rightTitleStyle,
    super.rightLabelStyle,
    super.rightSubtitleStyle,
