...
class DemoButtonToggle extends StatefulWidget {
  const DemoButtonToggle({super.key});

  @override
  State<DemoButtonToggle> createState() => _DemoButtonToggleState();
}

class _DemoButtonToggleState extends State<DemoButtonToggle> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("button toggle")),
      body: Center(
