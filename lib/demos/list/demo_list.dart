...
import 'package:flutter_gallery_next/demos/list/demo_list_multi.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => DemoListLong(items: List<String>.generate(10000, (i) => 'Item $i'))));
                },
                child: const Text("list long")),
            ElevatedButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => DemoListMulti(
