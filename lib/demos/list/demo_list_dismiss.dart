...
class DemoListDismiss extends StatefulWidget {
  const DemoListDismiss({super.key});

  @override
  DemoListDismissState createState() {
    return DemoListDismissState();
  }
}

class DemoListDismissState extends State<DemoListDismiss> {
